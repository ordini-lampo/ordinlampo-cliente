...
function LiveSummary({
  ...
  return (
    <div className="summary-fixed bg-gradient-to-r from-orange-600 via-red-600 to-pink-600 border-t-4 border-yellow-500 shadow-2xl">
      {/* GLOW EFFECT */}
      ...
      <button
        ...
        className="w-full p-4 flex items-center justify-between relative z-10 transition-all hover:scale-[1.02]"
      >
        <div className="flex items-center gap-3">
          <div className="w-12 h-12 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center shadow-lg border-2 border-white/40">
        ...
        <div className="flex items-center gap-4">
          <div className="text-right">
            ...
            <p className="font-black text-3xl text-yellow-300 drop-shadow-[0_2px_8px_rgba(255,215,0,0.5)] tracking-tight">
              €{calculateTotal().toFixed(2)}
            </p>
          </div>
          <div className={`w-8 h-8 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center transition-transform ${expanded ? 'rotate-180' : ''}`}>
      ...
      {/* Dettagli espansi */}
      {expanded && (
        <div className="px-4 pb-4 border-t-2 border-white/20 animate-fadeIn backdrop-blur-sm bg-white/10">
          {/* Bowls */}
          ...
          {totalBeverages > 0 && (
            <div className="py-2 border-b border-white/10">
              <p className="font-bold text-white drop-shadow">🥤 Bevande</p>
              <p className="text-xs text-white/80 drop-shadow">
